---
title: "NYT16 Pred Tables Hard Soft"
...
## Load data 
df_nyt16 <- import("/Users/dw28396/Dropbox/db2/predictions/agg_2016_nyt_pred.csv")
...
#mean(df_nyt16_2$Hard)
#mean(df_nyt16_2$Soft)
```


```{r tab:nyt16_pred_hard_soft, echo=FALSE, results='asis'}
df_nyt16_2  %>% 
  kable("latex", booktabs = T, caption = "NYT16 Prediction - Share of Hard and Soft News",  align = "l") %>% 
